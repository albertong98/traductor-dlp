...
public class TypeChecking extends DefaultVisitor {
    ...
    /*
     * Poner aqu铆 los visit necesarios.
...
//	class Program { List<Definition> definitions; }
	...
	public Object visit(Print node, Object param) {
		...
		predicado(tipoSimple(node.getExpression().getType()),"la expresi髇 debe ser de tipo simple",node);
	...
	public Object visit(Read node, Object param) {
		...
		predicado(tipoSimple(node.getExpression().getType()),"la expresi髇 debe ser de tipo simple",node);
		predicado(node.getExpression().isModificable(),"la expresi髇 debe ser modificable",node);
	...
	public Object visit(Function node, Object param) {
		...
		if (node.getExpressions() != null)
			for (Expression child : node.getExpressions())
				child.accept(this, param);
		predicado(node.getExpressions().size() == node.getDefinition().getParams().size(),"No coincide el n鷐ero de parametros",node);
