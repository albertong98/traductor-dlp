...
public class ASTPrinter extends DefaultVisitor {
	...
	public Object visit(StructDefinition node, Object param) {
		...
		visit(indent + 1, "structtype", "StructType",node.getStructtype());
	...
	public Object visit(FuncDefinition node, Object param) {
		...
		visit(indent + 1, "defs", "List<Definition>",node.getDefs());
	...
	public Object visit(Function node, Object param) {
		...
		print(indent + 1, "name", "String", node.getName());
		visit(indent + 1, "expressions", "List<Expression>",node.getExpressions());
		return null;
	}
	...
	public Object visit(Cast node, Object param) {
		...
		visit(indent + 1, "targetType", "Type",node.getTargetType());
	...
	public Object visit(FunctionExpression node, Object param) {
		...
		printName(indent, "FunctionExpression", node, false);
